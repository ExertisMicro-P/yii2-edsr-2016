...
$showKeys  = isset($selectedDetails['showkeys']) && $selectedDetails['showkeys'];
$totalKeys = 0;
foreach ($selectedDetails['pos'] as $purchaseOrderNumber => $po) {
    $totalKeys += count($po);
}

$totalKeysMessage = Yii::t('app', $totalKeys . ' {totalkeys, plural, =0{No new keys} =1{New key is} other{New keys are}} now available in', ['totalkeys' => $totalKeys]) ;
?>
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=650>
    ...
    <tr>
        ...
        <td colSpan=2>
            ...
            <p><?= $totalKeysMessage ?>
                your <?= Html::a('Exertis Digital Stock Room', 'https://stockroom.exertis.co.uk') ?>.</p>
            <p>Please visit <?= Html::a('our Help Page', 'https://stockroom.exertis.co.uk/site/help') ?> for FAQs,
                Support Contacts and Download Links</p>
        </td>
    </tr>
    <TR>
