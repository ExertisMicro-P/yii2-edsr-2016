...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
        <td align="center" valign="middle" height="90"><a
                    href=""><img
                        src="http://res.cloudinary.com/exertis-uk/w_118,h_50,c_pad/manu_logos/Intel_Security_i_hrz_rgb_3000_1.png"
                        border="0" title="mcafee logo" alt="mcafee logo"/></a></td>
    </tr>
</table>
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center" valign="middle"
                                                ...
                                                class="fontSize">Your McAfee Antivirus is here. Download now!
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="left" valign="middle" class="center hidePad"
                                                ...
                                                Thanks for buying your McAfee Antivirus from <a
                                                    href="http://ao.com/?WT.z_PT=MDA&WT.z_MT=Retention&WT.z_RTM=Email&WT.z_EMT=transactional&WT.z_EMN=ESD&WT.srch=1"
                                                    style="color:#484442; text-decoration:none">ao.com</a>. No CD required. 
                                                    Your McAfee software is downloaded online to ensure you get our newest version. 
                                                    Simply follow the 4 steps below and McAfee Antivirus will be ready to use in no time.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                        ...
                                        <tr>
                                            <td align="left" valign="middle"
                                                ...
                                                class="center hidePad"><strong>4 simple steps to download. Get
                                                started...</strong></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                                ...
                                                class="center hidePad"><strong>1.</strong> Highlight and copy this activation code.
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                            <td height="10" style="font-size:0px;line-height:0px">&nbsp;</td>
                                            ...
                                            <td align="left" valign="middle"
                                                ...
                                                class="center hidePad"><strong>2.</strong> Go to: <span
                                                    class="AOLcolor"><a href="www.mcafee.com/mav/retailcard"
                                                                        style="color:#484442; text-decoration:underline" target="_blank"><strong>www.mcafee.com/activate</strong></a></span>
                                                (this will open in a new tab). Your screen will look like the image below.
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                            <td>&nbsp;</td>
                                        ...
                                        <tr>
                                            <td align="left" valign="middle" style="padding-left:10px; padding-right:10px" class="center hidePad"><img src="http://wpm.ccmp.eu/wpm/100104/ContentUploads/McAfee_image0710162.jpg" width="225" height="204" style="display:block" border="0" alt="Screen Shot" title="Screen shot" class="center"></td>
                                         </tr>
                                            ...
                                            <td align="left" valign="middle"
                                                style="color:#484442; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:130%;  padding-left:10px; padding-right:10px"
                                                class="center hidePad"><strong>3.</strong> Paste your activation code from step 1</td>
                                                                                                        </tr>
                                        <tr>
                                        </tr>
                                                                                                        <tr>
                                            <td align="left" valign="middle"
                                                style="color:#484442; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:130%;  padding-left:10px; padding-right:10px"
                                                class="center hidePad"><strong>.</strong> Follow the on-screen instructions to download and install your software
                                                                                                            </td>
                                                                                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                        ...
                                        <!--<tr>
                                            <td align="left" valign="middle"
                                                style="color:#484442; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:130%;  padding-left:10px; padding-right:10px"
                                                class="center hidePad"><strong>4.</strong> Follow the instructions to download your software.
                                                                                </td>
                                                                            </tr>-->
                                                                    <tr>
                                            <td height="8" style="font-size:0px;line-height:0px">&nbsp;</td>
