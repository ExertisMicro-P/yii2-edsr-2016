...
class Product extends \common\models\BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['item_code', 'manu_part_number', 'range', 'env_tax_ammount', 'grp_desc', 'cat1', 'cat2', 'cat3', 'cat4', 'cat5', 'cat6', 'cat7', 'cat8', 'topcat', 'quickcat', 'webcat1', 'webcat2', 'webcat3', 'webcat4', 'spec_url', 'manu'], 'string', 'max' => 500],
            [['short_description'], 'string', 'max' => 1000],
            [['product_status', 'item_status', 'stock_group', 'sdp', 'division'], 'string', 'max' => 50],
    ...
    {
        return $this->hasOne(DigitalProduct::className(), ['partcode' => 'item_code']);
    }
    ...
    {
        return $this->hasMany(StockItem::className(), ['productcode' => 'item_code']);
    }
}
