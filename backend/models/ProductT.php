...
class ProductT extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['item_code', 'manu_part_number', 'range', 'env_tax_ammount', 'grp_desc', 'cat1', 'cat2', 'cat3', 'cat4', 'cat5', 'cat6', 'cat7', 'cat8', 'topcat', 'quickcat', 'webcat1', 'webcat2', 'webcat3', 'webcat4', 'spec_url', 'manu', 'manu_part_number_sanitised'], 'string', 'max' => 500],
