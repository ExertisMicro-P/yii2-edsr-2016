...
class EDSRGAuthify {
    ...
    /**
     * overrides request_handler
     *
     * @param type $type
     * @param type $url_addon
     * @param type $params
     * @return type
    ...
    private function request_handler($type, $url_addon = '', $params = array())
    {
        ...
        foreach ($this->access_points as $base_url) {
            try {
                ...
                // RCH 20141212
                // Seems to be needed on dev server and using XAMPP.
                // Not needed on ma-webproxy-02
                if (!\Yii::$app->params['gauthify.skipSSL']) {
                    curl_setopt($req, CURLOPT_SSL_VERIFYPEER, true);
                    curl_setopt($req, CURLOPT_SSL_VERIFYHOST, 2);
                    curl_setopt($req, CURLOPT_CAINFO, getcwd() ."\..\config\gauthify2.cer");
                    Yii::info(__METHOD__.': '.getcwd() ."\..\config\gauthify2.cer");
                }
                // RCH 20141212
