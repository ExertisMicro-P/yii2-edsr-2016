<?php
namespace common\components\Cloudinary {

    
    use common\components\Cloudinary\Cloudinary;
        ...
        public static function call_api($action, $params, $options = array(), $file = NULL)
        {
            ...
            if (isset($result["error"])) {
                if ($return_error) {
                    ...
                    throw new \yii\web\HttpException($code, $result['error']['message']);
