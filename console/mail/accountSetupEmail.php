                    ...
                    <TBODY>
                        <TR>
                            <TD>
                                ...
                                <p><?php echo  $customer->name.' ('.$customer->exertis_account_number.') '.Yii::t("app", "urgently needs access to Exertis Digital Stock Room (EDSR)") ?></p>
                                <p><?=
                                    Yii::t("app", "EDSR stores Customer's digital products which they have bought from Exertis UK. "
                                            . "They cannot access their Digital Stock Room until their email address has been setup by their account manager."
                                            . "If you are ". $customer->name. '\'s Account Manager then please take action now.');
                                    ?></p>

                                <p><?= Yii::t("app", "Click the link below, log in and follow the instructions:") ?></p>
                                <p><a href='http://edsr.exertis.co.uk/sales-rep-account-email-form?id=<?= $account->id ?>'>https://edsr.exertis.co.uk/sales-rep-account-email-form?id=<?= $account->id ?></a></p>
								<!--<p><a href='https://edsrb/sales-rep-account-email-form?id=<?= $account->id ?>'>https://edsrb/sales-rep-account-email-form?id=<?= $account->id ?></a></p>-->

                                <p><?= Yii::t("user", "To find out more about the Exertis Digital Stock Room, please visit ") ?></p>
                                <a href='https://stockroom.exertis.co.uk'>https://stockroom.exertis.co.uk</a>
                                <p>Thanks!</p>
