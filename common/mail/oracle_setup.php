...
// This email goes to Lisa Bailey to ask her to check that the account is set up in Oracle 
// and ready for EDI
            ...
            <TD class=email-content width=610><BR><BR>
                <TABLE border=0 cellSpacing=0 cellPadding=0>
                    <TBODY>
                        <TR>
                            <TD>
                                <h3><?= Yii::t("app", "Exertis Digital Stock Room") ?></h3>

                                
                                <p><?=
                                    Yii::t("app", "A new account has been enabled in EDSR. Please could you check that account <strong>".$accountNumber.'</strong> is fully enabled for EDI?')
                                    ?></p>
