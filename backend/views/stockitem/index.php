...
<div class="stock-item-index">
    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'columns' => [
            ...
            [
             'label'=>'Stock Room',
             'filter' => Html::activeInput('text', $searchModel, 'stockroom_id', ['class'=>'form-control']),
             'format' => 'raw',
             'value'=>function ($data) {
                        return Html::a($data->stockroom_id,Url::to(['stockroom/view','id'=>$data->stockroom_id]), ['data-pjax'=>'0']);
                      },
             ],
            [
                'format'=>'html',
